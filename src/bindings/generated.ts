...
async updateMistakePuzzleCompletion(dbPath: string, puzzleId: bigint, completed: number) : Promise<Result<null, string>> {
    try {
...
export type AnalyzeGamesRequest = { id: string; engine: string; engineType: string; goMode: GoMode; uciOptions: EngineOption[]; dbPath: string; mistakeDbPath: string; username: string; source: string; minWinChanceDrop: number }
...
export type MistakePuzzle = { id: bigint; source: string; username: string; gameId: string; fen: string; playerColor: string; whitePlayer: string; blackPlayer: string; playedMove: string; bestMove: string; bestLine: string; opponentPunishment: string; opponentLine: string; annotation: string; cpLoss: number; winChanceDrop: number; evalBefore: string; evalAfter: string; moveNumber: number; engineDepth: number; dateAnalyzed: string; completed: number; predecessorFen: string; predecessorMove: string; isMiss: number; missOpportunityCp: number; moveClassification: string; missType: string; evalDelta: number; mateIn: number }
...
export type MistakeStats = { total: bigint; solvedCorrect: bigint; solvedWrong: bigint; unsolved: bigint; blunders: bigint; mistakes: bigint; inaccuracies: bigint; misses: bigint; accuracy: number; gameAccuracy: number }
